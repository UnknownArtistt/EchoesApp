...
import com.example.echoesapp.databinding.FragmentPictoRecyclerDolorBinding;
...
public class PictoRecyclerDolor extends Fragment implements TextToSpeech.OnInitListener {

    private FragmentPictoRecyclerDolorBinding binding;
    private PictogramViewModel pictogramViewModel;
    private NavController navController;
    private TextToSpeech textToSpeech;
    public PictoRecyclerDolor() {
        // Required empty public constructor
    }
    public static PictoRecyclerDolor newInstance(String param1, String param2) {
        PictoRecyclerDolor fragment = new PictoRecyclerDolor();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return (binding = FragmentPictoRecyclerDolorBinding.inflate(inflater, container, false)).getRoot();
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        PictoRecyclerDolor.PictogramAdapterDolor pictogramAdapter = new PictoRecyclerDolor.PictogramAdapterDolor();
        binding.recyclerViewDolor.setAdapter(pictogramAdapter);

        getFilter(3).observe(getViewLifecycleOwner(), new Observer<List<Pictogram>>() {
            @Override
    ...
    class PictogramAdapterDolor extends RecyclerView.Adapter<PictoViewHolder> {
